...
`);
  ...
  const crons = [
    ...
    { name: `${teamPrefix}intel-scan`, cron: `0 ${mh-1} * * 1,3,5`, agent: `${teamPrefix}intel-analyst`, deliver: '--no-deliver', msg: 'Competitor scan: 1. Read competitor-map. 2. Search news. 3. Update map. 4. Alert on findings.' },
    { name: `${teamPrefix}content-weekly-plan`, cron: `0 ${mh+1} * * 1`, agent: `${teamPrefix}content-chief`, deliver: '--no-deliver', msg: 'Weekly content plan: 1. Read decisions+inbox. 2. Plan this week content. 3. Start first piece.' },
  ];
